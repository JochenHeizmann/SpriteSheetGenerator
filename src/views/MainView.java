...
public class MainView {
	...
	private void initialize() {
		...
		chooser.setFileFilter(new FileNameExtensionFilter("Image files", "png", "gif", "jpg", "jpeg", "tiff", "tga"));
		
		panelSpritesheet.setBorder(new TitledBorder(null, "Preview", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelFiles.setBorder(new TitledBorder(null, "Images", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelSave.setBorder(new TitledBorder(null, "Save Spritesheet", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		buttonSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(returnVal == JFileChooser.APPROVE_OPTION) {
					...
					try {
						ImageIO.write(Converter.convert(model.getImages(), format), "png", new File(chooser.getSelectedFile().getAbsoluteFile().toString()));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
